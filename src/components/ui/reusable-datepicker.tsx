...
//             value={month.getMonth()}
//             onChange={handleMonthChange}
//             className="text-sm font-medium border border-gray-300 rounded px-2 py-1 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer max-w-[110px]"
//             title="Select month"
//             size={1}
//           >
//             {monthNames.map((name, index) => (
...
//             value={month.getFullYear()}
//             onChange={handleYearChange}
//             className="text-sm font-medium border border-gray-300 rounded px-2 py-1 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer max-w-[80px]"
//             title="Select year"
//             size={1}
//           >
//             {yearRange.map((year) => (
...
//                   className="hover:bg-gray-200 rounded p-1 text-gray-500 flex-shrink-0 z-10"
