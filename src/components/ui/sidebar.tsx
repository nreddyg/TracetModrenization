...
>(({ className, ...props }, ref) => {
  return (
     <ScrollArea className="flex-1" scrollStyle={'flex-[0.6] bg-[#6c79b3]'}>
    <div
      ref={ref}
      data-sidebar="content"
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 pe-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    data-sidebar="menu"
    className={cn("flex w-full min-w-0 flex-col gap-1 p-1 pt-2", className)}
    {...props}
  />
))
