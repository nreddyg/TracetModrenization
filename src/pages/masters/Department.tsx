    ...
    <div className="bg-hsl(214.3 31.8% 91.4%)">
      ...
      <div className="flex h-full px-2 pt-1 gap-3">
        ...
        <div className="w-[26vw] h-[75vh] rounded-lg shadow-lg border bg-card flex flex-col">
          ...
          <ScrollArea scrollStyle={'flex-[0.8] '}  className="min-h-20 h-[63vh] overflow-y-auto p-2" horizontal>
        ...
        <div className="flex-1 h-[75vh] border ps-2  bg-card border-b rounded-lg  lg:px-6 py-3 flex flex-row xxs:flex-col xs2:flex-row lg:flex-row lg:items-center justify-between gap-4">
          {/* <div className="bg-card border-b rounded-lg shadow-lg lg:px-6 py-3 flex flex-row xxs:flex-col xs2:flex-row lg:flex-row lg:items-center justify-between gap-4"> */}
            <div className="p-1 pt-2 w-full space-y-6 h-[71vh]">

              <div className="flex flex-col gap-2">
                <div>
                  <h4 className="master-heading mb-2 flex items-center gap-2 text-xl font-bold ">
                    {!recordToEditId
                      ? selectedLevel === 99
                        ? "Department"
                        : "Add Department"
              ...
              <div className="space-y-6">
                <h5 className='text-md font-semibold'>{recordToEditId && selectedLevel !== 99 ? `Update ${departrmentData[0].heading}` : `${selectedLevel !== 99 ? "Enter" : ""} ${departrmentData[0].heading}`}</h5>
                <div className="px-1">
                  <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4">
                    {getFieldsByNames(['Name', 'Code']).map((field) => {
                      return <div className="flex items-center space-x-2">
