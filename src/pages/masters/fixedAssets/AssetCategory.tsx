        ...
        return (
            ...
            <div className="p-4 sm:p-4 space-y-4 sm:space-y-4">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            ...
                            <h1 className="text-2xl font-bold ">Asset Category</h1>
                    ...
                    <div className="">
                        ...
                        <Dialog open={isSubDialogOpen} onOpenChange={() => subDialogFN()}>
                            <DialogContent>
                                ...
                                <div className="flex justify-end gap-2">
                                    <ReusableButton  variant="text" className='btn-reset-clear-style' onClick={() => setIsSubDialogOpen(false)}>
                                        Cancel
                                    </ReusableButton>
                                    <ReusableButton variant="primary" className='btn-submit-style' onClick={(e) => { handleSubmit(() => submit(e, false))(e) }}>
                        ...
                        <Dialog open={isSubDelOpen} onOpenChange={setIsSubDelOpen}>
                            <DialogContent>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-end gap-2">
                                        <ReusableButton  variant='text' className="btn-reset-clear-style" onClick={() => setIsSubDelOpen(false)}>
                                            Cancel
                                        </ReusableButton>
                                        <ReusableButton    variant="primary"  danger={true} onClick={() => handleMainDelete(subRecID, companyId, '')}>
                                            Delete
                                        </ReusableButton>
                                    </div>
                                </div>
