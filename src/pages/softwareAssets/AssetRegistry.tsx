...
const SoftwareDataColumns = [
    ...
    { id: 'Licensekey', accessorKey: "License Key", header: "License Key" },
    { id: 'AssignmentDate', accessorKey: "Assignment Date", header: "Assignment Date" },
    { id: 'Expiry Date', accessorKey: "Expiry Date", header: "Expiry Date" },
