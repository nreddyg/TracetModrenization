import { URL_DELETE_BOOK_CATEGORY, URL_DELETE_DEPRECIATION_BOOK, URL_DELETE_GROUP_BY_ID, URL_DEP_BOOK_DETAILS, URL_GET_ADDITIONAL_DEPRECIATION_BOOK, URL_GET_BOOK_CATEGORY_LIST, URL_GET_CHECK_DEP_RAN_FY, URL_GET_DEPRECIATION_BOOK_DETAILS_BY_ID, URL_GET_EFFECTIVE_FROM_DATE, URL_GET_GROUP_BY_BOOK_ID, URL_POST_ADD_ADDITIONAL_DEPRECIATION, URL_POST_ADD_DEPRECIATION_MASTER, URL_POST_ADD_GROUP_CATEGORY_DETAILS, URL_POST_UPDATE_ADDITIONAL_DEPRECIATION, URL_POST_UPDATE_BOOK_DETAILS, URL_POST_UPDATE_GROUP_CATEGORY_DETAILS, } from "@/config/apiUrls";
import api from "./api";
