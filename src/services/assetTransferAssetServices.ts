import { URL_ADD_OR_UPDATE_SOFTWARE_LICENSE, URL_ASSET_TRANSFER_LIST, URL_BASIC_SEARCH, URL_DELETE_SOFTWARE_BY_ID, URL_DELETE_SOFTWARE_LICENSE_BY_ID, URL_FILTER_SEARCH, URL_GET_ALL_CATEGORIES, URL_GET_SOFTWARES_LICENSES_LIST, URL_GET_VENDOR_DETAILS_BY_COMPID, URL_GRID_COLS } from "@/config/apiUrls";
import api from "./api";
