...
import {URL_GET_NOTIFY_TYPE_LOOKUPS,URL_GET_SERVICE_REQUEST_STATUS, URL_GET_SERVICE_REQUEST_TYPES, URL_GET_SERVICE_REQUEST_TYPES_BY_ID, URL_GET_SR_ASSIGN_TO_LOOKUPS, URL_GET_SR_REQUESTED_BY_LOOKUPS, URL_GET_SRCONFIG_LIST, URL_GET_STATUS_LOOKUP_API, URL_GET_STATUS_LOOKUP_FOR_CALCULATE_SLA_API, URL_GET_VENDOR_DETAILS_BY_COMPID, URL_POST_ADD_SR_STATUS, URL_POST_DELETE_SR_STATUS, URL_POST_DELETE_SR_TYPE_BY_ID, URL_POST_SERVICE_REQUEST_CONFIGURATION, URL_POST_SERVICE_REQUEST_TYPE, URL_POST_UPDATE_SR_STATUS, URL_POST_UPDATE_SR_STATUS_SEQUENCE, URL_POST_UPDATE_SR_TYPE } from '@/config/apiUrls';
import api from './api';
