import { URL_DELETE_ITEM_MASTER, URL_DELETE_STORE, URL_DELETE_UNITS_OF_MEASURE, URL_GET_ITEM_MASTER_DATA, URL_GET_STORE_DATA, URL_GET_UNITS_OF_MEASURE_DATA, URL_GET_UNITS_OF_MEASURE_DATA_BY_ID, URL_POST_NEW_ITEM_MASTER, URL_POST_NEW_STORE, URL_POST_NEW_UNITS_OF_MEASURE, URL_POST_UPDATE_ITEM_MASTER, URL_POST_UPDATE_STORE, URL_POST_UPDATE_UNITS_OF_MEASURE } from '@/config/apiUrls';
import api from './api';
